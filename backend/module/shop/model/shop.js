function print_cars(consulta) {
    ...
    friendlyURL('?page=shop&op=print_cars').then(function(data) {
    
        ajaxPromise(data, 'POST', 'JSON', { con : consulta })
        ...
        .then(function(data_print) {
            ...
            if (data_print=='no' | data_print.length==0) {
                ...
                for (row in data_print) {
                    ...
                    $('<img></img>').attr('class', 'img-responsive').attr('src', 'http://localhost/' + data_print[row].img).appendTo('.ww_'+cont);
                ...
                friendlyURL('?page=shop&op=liked').then(function(data) {
                    ajaxPromise(data, 'POST', 'JSON', { user : user})
...
function print_details(car_id) {
    ...
    friendlyURL('?page=shop&op=details_car').then(function(data) {
        ajaxPromise(data, 'POST', 'JSON', { id : car_id})

        .then(function(data_details) {
        
            // VIEWS UP
            friendlyURL('?page=shop&op=update_views').then(function(data) {
                $.ajax({
                    url: data,
                    type: 'POST',
                    dataType: 'JSON',
            ...
            // IMGS
            friendlyURL('?page=shop&op=details_img').then(function(data) {
                ajaxPromise(data, 'POST', 'JSON', { id : car_id})
                ...
                .then(function(data_img) {
                    ...
                    for (row in data_img) {
                        ...
                        if (cont == 0) {
                            $('<div></div>').attr('class', 'item active main-item').attr('style', 'background-image: url(' + 'http://localhost/' + data_img[row].img +')').appendTo('.car-container');
                            
                        } else {
                            $('<div></div>').attr('class', 'item item_'+cont).attr('style', 'background-image: url(' + 'http://localhost/' + data_img[row].img +')').appendTo('.car-container');
...
function build_categorias() {
    ...
    friendlyURL('?page=shop&op=categorias').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function build_marcas() {
    ...
    friendlyURL('?page=shop&op=marcas').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function build_color() {
    ...
    friendlyURL('?page=shop&op=color').then(function(data) { 
        ajaxPromise(data, 'GET', 'JSON')
...
function build_funcionamiento() {
    ...
    friendlyURL('?page=shop&op=funcionamiento').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function build_manejo() {
    ...
    friendlyURL('?page=shop&op=manejo').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function build_gps() {
    ...
    friendlyURL('?page=shop&op=gps').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function build_wifi() {
    ...
    friendlyURL('?page=shop&op=wifi').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function build_asientos() {
    ...
    friendlyURL('?page=shop&op=asientos').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function build_puertas() {
    ...
    friendlyURL('?page=shop&op=puertas').then(function(data) {
        ajaxPromise(data, 'GET', 'JSON')
...
function like(matricula, op) {
    ...
    friendlyURL('?page=shop&op=favs').then(function(data) {
        ajaxPromise(data, 'POST', 'JSON', {mat : matricula, user: user, oper: op})
    });
