<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo SITE_PATH ?>view/css/login-register.css">
    <script src="<?php echo SITE_PATH ?>module/login/model/login-register.js"></script>
    <script src="<?php echo SITE_PATH ?>module/login/model/login.js"></script>
